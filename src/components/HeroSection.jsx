      ...
      <div className="container mx-auto grid max-w-6xl items-center gap-12 lg:grid-cols-[1.05fr_0.95fr]">
        <div className="text-left">
          <div className="mb-6 inline-flex items-center gap-2 rounded-full border border-primary/30 bg-card/80 px-4 py-2 text-sm text-foreground/80 shadow-sm backdrop-blur">
            ...
            Available for client websites &amp; full-stack engineering
          </div>
          ...
          <h1 className="font-heading max-w-4xl text-5xl font-black leading-tight tracking-tight md:text-7xl">
            Engineering high-impact <span className="text-gradient">web products &amp; client platforms.</span>
          </h1>
          ...
          <p className="mt-6 max-w-2xl text-lg leading-8 text-muted-foreground md:text-xl">
            Full Stack Web Developer &amp; Engineer from {profile.location}. I design and build high-performance React frontends, robust Node.js APIs, responsive client websites, and scalable architectures that turn business ideas into measurable reality.
          </p>
