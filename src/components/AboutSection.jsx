          ...
          <SectionReveal className="sticky top-28 text-left">
            ...
            <div className="mt-8 flex items-center gap-6">
              <div className="relative">
                <div className="absolute -inset-1 rounded-full bg-gradient-to-br from-primary via-primary/60 to-primary/30 animate-[gradient-shift_4s_ease-in-out_infinite]" style={{ backgroundSize: "200% 200%" }} />
                <img
                  src={profile.avatar}
