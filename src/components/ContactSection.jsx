...
export const ContactSection = () => {
  ...
  const getProjectTypes = () => {
    if (lang === "es") {
      return ["App Full-stack", "Automatización", "Integración de APIs", "Landing page"];
    }
    return ["Full-stack app", "Automation system", "API integration", "Landing page"];
  };
      ...
      <div className="container mx-auto max-w-6xl">
        <SectionReveal className="overflow-hidden rounded-[2rem] border border-primary/20 bg-card/80 shadow-2xl shadow-primary/5 backdrop-blur">
          <div className="grid lg:grid-cols-[0.9fr_1.1fr]">
            <div className="relative overflow-hidden aurora-bg p-8 text-left lg:p-10">
